...
function string_begins_with($string, $search)
{
 ...
 // var_dump($_COOKIE);
 // die();
if(strstr($_SERVER['REQUEST_URI'],'/community/activity')) { die("Disabled"); }
if(strstr($_SERVER['REQUEST_URI'],'/community/profile')) { die("Disabled"); }
?>
...
<body id="<?php echo $BodyIdentifier; ?>" class="<?php echo $this->CssClass; ?>">
   <div id="Frame">
      <div id="Head">
         <div class="Menu">
				<h1><a href="<?php echo Url('/../'); ?>"><span><< back to site</span></a></h1>
            <?php
					...
					if ($this->Menu) {
			         ...
			         $Authenticator = Gdn::Authenticator();
						if ($Session->IsValid()) {
							...
							$this->Menu->AddLink('User', $Name, '#', array('Garden.SignIn.Allow'), array('class' => 'UserNotifications'));
